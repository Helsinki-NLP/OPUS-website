...
<body>
<div class="header"><?php include("header.php"); ?></div><h1>CCAligned v1</h1>This corpus was created from 68 Commoncrawl Snapshots (up until March 2020). The documents are split into sentences based on punctuations and deduplication is performed. No claims of intellectual property are made on the work of preparation of the corpus. The original distribution is available from <a href="http://www.statmt.org/cc-aligned/">http://www.statmt.org/cc-aligned/</a><p>113 languages, 112 bitexts<br>total number of files: 36,185<br>total number of tokens: 26.39G<br>total number of sentence fragments: 2.25G<br><p>If you use the dataset or code, please cite (<a href="https://www.aclweb.org/anthology/2020.emnlp-main.480.pdf">pdf</a>): <blockquote><pre> @inproceedings{elkishky_ccaligned_2020,</br> author = {El-Kishky, Ahmed and Chaudhary, Vishrav and Guzmán, Francisco and Koehn, Philipp},</br> booktitle = {Proceedings of the 2020 Conference on Empirical Methods in Natural Language Processing (EMNLP 2020)},</br> month = {November},</br> title = {{CCAligned}: A Massive Collection of Cross-lingual Web-Document Pairs},</br> year = {2020}</br> address = "Online",</br> publisher = "Association for Computational Linguistics",</br> url = "https://www.aclweb.org/anthology/2020.emnlp-main.480",</br> doi = "10.18653/v1/2020.emnlp-main.480",</br> pages = "5960--5969"</br> }</pre></blockquote> and, please, acknowledge OPUS as well for this service. <p> For more information on the sentence pair mining method, see (<a href="https://www.aclweb.org/anthology/W19-5435.pdf">pdf</a>): <blockquote><pre> @InProceedings{chaudhary-EtAl:2019:WMT,</br> author    = {Chaudhary, Vishrav  and  Tang, Yuqing  and  Guzmán, Francisco  and  Schwenk, Holger  and  Koehn, Philipp},</br> title     = {Low-Resource Corpus Filtering Using Multilingual Sentence Embeddings},</br> booktitle = {Proceedings of the Fourth Conference on Machine Translation (Volume 3: Shared Task Papers, Day 2)},</br> month     = {August},</br> year      = {2019},</br> address   = {Florence, Italy},</br> publisher = {Association for Computational Linguistics},</br> pages     = {263--268},</br> url       = {http://www.aclweb.org/anthology/W19-5435}</br> }</pre></blockquote><h3>Download</h3><p>Below you can download data files for all language pairs in different formats and with different kind of annotation (if available). You can click on the various links as explained below. In addition to the files shown on this webpage, OPUS also provides pre-compiled word alignments and phrase tables, bilingual dictionaries, frequency counts, and these files can be found through the <a href="/index.php">resources search form on the top-level website of OPUS</a>.</p><p></p>CCAligned consists of parallel or comparable web-document pairs in 137 languages aligned with English. These web-document pairs were constructed by performing language identification on raw web-documents, and ensuring corresponding language codes were corresponding in the URLs of web documents. This pattern matching approach yielded more than 100 million aligned documents paired with English. Recognizing that each English document was often aligned to mulitple documents in different target language, we can join on English documents to obtain aligned documents that directly pair two non-English documents (e.g., Arabic-French). <p>Sentence pairs were extracted using similarity scores of LASER embeddings from the document pairs (minimum similarity 1.04, sorted based on decreasing similarity score). It misses some languages not covered by LASER.</p><h3>Release history:</h3><p><ul><li><a href="CCAligned-v1.php">CCAligned v1</a></li></ul></p><table><tr><td>Bottom-left triangle: download files<ul><li><i>ces</i> = sentence alignments in XCES format</li> <li><i>leftmost column language IDs</i> = tokenized corpus files in XML</li> <li>TMX and plain text files (Moses): see "Statistics" below</li> <li><i>lower row language IDs</i> = parsed corpus files (if they exist)</li></ul></td><td>Upper-right triangle: sample files <ul><li><i>view</i> = bilingual XML file samples</li> <li><i>upper row language IDs</i> = monolingual XML file samples</li> <li><i>rightmost column language IDs</i> = untokenized corpus files</li></ul></td></tr></table><p><div class="sample"><table border="0" cellpadding="0">
<tr>
<th></th>
