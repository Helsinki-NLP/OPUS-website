...
$BaseDir = "/cwb/OpenSubtitles2018";	                # base URL for HTML pages and data files of the CQPDemo
...
$Registry = '/home/opus/public_html/cwb/reg/OpenSubtitles2018';				# set to registry directory if not in standard registry
