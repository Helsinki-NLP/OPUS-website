...
<body>
<div class="header"><?php include("header.php"); ?></div><h1>pmindia v1</h1>This directory contains the releases of the pmindia corpus. It is a parallel corpus containing 13 Indian languages, plus English, derived from the Prime Minister of India&apos;s news updates (https://www.pmindia.gov.in/en/news-updates/). We release a sentence aligned version of the corpus, as well as the monolingual text extracted from the articles.<p>14 languages, 13 bitexts<br>total number of files: 26<br>total number of tokens: 21.37M<br>total number of sentence fragments: 0.86M<br><p><h3>Acknowledgements</h3> This work has received funding from the European Unions Horizon 2020 research and innovation programme under grant agreement No 825299 (Gourmet). We thank the Prime Minister&apos;s Office of the Government of India for making the content available for re-distribution. If you use the corpus, please cite: <blockquote><pre><br/> @ARTICLE{2020arXiv200109907H,<br/> author = {{Haddow}, Barry and {Kirefu}, Faheem},<br/> title = "{PMIndia -- A Collection of Parallel Corpora of Languages of India}",<br/> journal = {arXiv e-prints},<br/> keywords = {Computer Science - Computation and Language},<br/> year = "2020",<br/> month = "Jan",<br/> eid = {arXiv:2001.09907},<br/> pages = {arXiv:2001.09907},<br/> archivePrefix = {arXiv},<br/> eprint = {2001.09907}<br/> }<br/> </blockquote></pre> and also <a href="http://opus.lingfil.uu.se/LREC2012.txt">acknowledge the following article</a> if you use the OPUS packages and downloads in your own work:<br/> J. Tiedemann, 2012, <a href="http://www.lrec-conf.org/proceedings/lrec2012/pdf/463_Paper.pdf"><i>Parallel Data, Tools and Interfaces in OPUS.</i></a> In Proceedings of the 8th International Conference on Language Resources and Evaluation (LREC 2012)<h3>Download</h3><p>Below you can download data files for all language pairs in different formats and with different kind of annotation (if available). You can click on the various links as explained below. In addition to the files shown on this webpage, OPUS also provides pre-compiled word alignments and phrase tables, bilingual dictionaries, frequency counts, and these files can be found through the <a href="/index.php">resources search form on the top-level website of OPUS</a>.</p><p><b>License:</b> CC-BY-SA 4.0<br/><b>Copyright:</b> The corpus is released under the CC-BY-4.0, in other words the corpus can be freely shared and adapted as long as appropriate<br/></p>The code for crawling and aligning is available at <a href="https://github.com/bhaddow/pmindia-crawler">https://github.com/bhaddow/pmindia-crawler</a><h3>Release history:</h3><p><ul></ul></p><table><tr><td>Bottom-left triangle: download files<ul><li><i>ces</i> = sentence alignments in XCES format</li> <li><i>leftmost column language IDs</i> = tokenized corpus files in XML</li> <li>TMX and plain text files (Moses): see "Statistics" below</li> <li><i>lower row language IDs</i> = parsed corpus files (if they exist)</li></ul></td><td>Upper-right triangle: sample files <ul><li><i>view</i> = bilingual XML file samples</li> <li><i>upper row language IDs</i> = monolingual XML file samples</li> <li><i>rightmost column language IDs</i> = untokenized corpus files</li></ul></td></tr></table><p><div class="sample"><table border="0" cellpadding="0">
<tr>
<th></th>
